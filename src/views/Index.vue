      ...
      <div class="md-layout">
        <div class="md-layout-item">
          <div class="image-wrapper">
            ...
            <div class="brand">
              <h1>KaydenPortfolio</h1>
              <h3>My peronal portfolio written in Vue.js</h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="md-layout text-center">
            ...
            <div class="md-layout-item md-size-50 md-small-size-100 mx-auto">
              <md-button
                href="https://portfolio.kaydentech.com/product/material-kit"
                target="_blank"
          ...
          <div class="md-layout text-center">
            <div class="md-layout-item md-size-66 md-small-size-100 mx-auto">
              ...
              <h4>
                We've just launched
                <a
                  href="https://portfolio.kaydentech.com/product/vue-material-dashboard-pro?ref=utp-mk-demos"
                  target="_blank"
                  >Vue Material Dashboard PRO</a
                >
                and
                <a
                  href="https://portfolio.kaydentech.com/product/vue-material-kit-pro?ref=utp-vmk-demos"
                  target="_blank"
            ...
            <div class="md-layout-item md-size-50 md-small-size-100 mx-auto">
              <div class="btn-container">
                ...
                >
                <md-button
                  href="https://portfolio.kaydentech.com/product/vue-material-dashboard-pro?ref=utp-vmd-demos"
                  class="md-button md-success md-lg md-upgrade"
                  target="_blank"
